    ...
    gates: [
      ...
      },
      {
        ...
        modes: [
          {
            name: 'Solo',
            unboundGoldReward: 8500,
            boundGoldReward: 8500,
            chestPrice: 5440,
            goldILvlLimit: Infinity,
          },
          {
